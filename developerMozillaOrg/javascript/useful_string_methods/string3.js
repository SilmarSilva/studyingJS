...
3. There is one more small fix to do — add a full stop onto the end of the quote, and save the
final version in a variable called finalQuote.
*/
...
let fixedQuote = lowerQuote[0].toUpperCase() + lowerQuote.slice(1);
let finalQuote = fixedQuote.replace('green eggs','crabs');
